...
//Компонент модального окна трекинга времени. Передается уже id работника в соответствии с исполняющими лицами выбранного задания
//Также уже передается id выбранного задания
//Содержит только поле ввода числа.
//За один день нельзя затрекать по каждому из состояний больше 8 часов. Этот момент обрабатывается на сервере 
//Добавление нового трекинга времени производится по дате на сегодняшний день
//Отправляется POST запрос на добавление новой строки данных в сущность Track 
